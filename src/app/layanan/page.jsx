   ...
   <section className="h-auto bg-primary block md:hidden lg:hidden xl:hidden 2xl:hidden text-center pb-10">
    ...
    <Swiper
     ...
     <SwiperSlide>
      <div
       id="layanan-lain"
       className="bg-tulang text-primary h-96 pb- mx-5 rounded-3xl text-2xl font-semibold py-5">
       DESAIN UI/UX
     ...
     <SwiperSlide>
      <div
       ...
       KONSULTASI
       <p className="font-normal text-lg py-5 text-justify text-balance px-5">
        Kalian masih bingung waktu udah punya usaha tapi gatau apa yang harus dilakuin biar iklan digital kalian naik? Tenang, di <span className="font-bold">CODEVORA</span> Kalian bisa konsultasi terkait iklan digital kalian loh! Kita bakal bantu iklan digital usaha kalian supaya orang orang bisa ngejangkau akun kalian. 
       </p>
       <button className="border rounded-full bg-primary text-tulang py-2 px-6 font-normal text-lg mt-3 transition-all ease-in-out duration-500 hover:bg-tulang hover:text-primary hover:border-primary">
        Konsultasi Sekarang
       </button>
