...
export default function Footer() {
 ...
 return (
  <footer className="flex h-72 bg-gradient-to-r from-primary to-secondary border-lg shadow-md text-tulang">
   <ul className="ml-14 py-20">
    <img
     src="/Codevora Logo.png"
     className="h-20 text-center ml-5"
     alt="Logo Footer"
    />
    <li className="opacity-40">
     <p className="text-xs font-thin pt-5 ml-2">SOLUSI DIGITAL TERBAIK UNTUK</p>
     <span className="text-xs font-thin pt-5">
   ...
   <ul className="flex py-9 ml-96">
    ...
    <li className="ml-24">
     ...
     <ul className="my-2 2xl:text-xl font-thin">
      <Link href="/about">
       <li className="mb-3 hover:text-blue-300">Profil Perusahaan</li>
      </Link>
      <Link href="/career">
       <li className="mb-3 hover:text-blue-300">Career</li>
      </Link>
      <Link href="/project">
